...
def listar_juegos():
    sql = text("SELECT id, name, year, description, img, url, play FROM games ORDER BY id ASC")
...
def crear_juego(request):
    ...
    sql = text("""
        ...
        RETURNING id
    """)
    # SQLite no soporta RETURNING en versiones antiguas: si falla, igual funciona sin usar el id
    try:
